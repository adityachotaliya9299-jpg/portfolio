            ...
            <div className="hero-grid">
              ...
              <div style={{ animation: 'fadeInUp 0.8s ease forwards' }}>
                ...
                <div style={{ display: 'flex', gap: '0.75rem', flexWrap: 'wrap', marginBottom: '2.5rem' }}>
                  ...
                  <a href="/api/resume" target="_blank" rel="noreferrer" className="btn btn-ghost" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem' }}>
                    📄 Resume
                  </a>
                </div>
...
>View All →</a>
        ...
        <a href="https://wa.me/919016711731" target="_blank" rel="noreferrer"
          ...
          onMouseLeave={e => { (e.currentTarget as HTMLElement).style.transform = ''; (e.currentTarget as HTMLElement).style.boxShadow = '0 4px 20px rgba(37,211,102,0.4)'; }}
        >
